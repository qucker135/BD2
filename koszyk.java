...
public class koszyk {
	...
	public void function(String PESEL) {
	    ...
	    //Do zmiennej amount of data wpisa� ilo�� produkt�w
	    //co� m�wili�my o tym, �eby by�y domy�lne warto�ci, to w pole imie, imie2 itd. trzeba by wstawi� domy�lny tekst. zostawiam do przemy�lenia
	    //w idKlienta jest id klienta, kt�ry teraz pracuje na aplikacji
	    //TODO BM + Franciszek
		//"SELECT "
	    ...
	    usun.addActionListener(new ActionListener() {
	        public void actionPerformed(ActionEvent e) {
	        	...
	        	//Twoja w tym g�owa, �eby w tym miejscu by� kod, kt�ry usuwa element z tabeli
	        	//TODO BM + Franciszek
	        }
	    });
